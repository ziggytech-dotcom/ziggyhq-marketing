...
export const metadata: Metadata = {
  title: "ZiggyHQ Blog — Tips, Guides & Insights",
  description: "Practical guides, how-to articles, and small business tips from the ZiggyHQ team. Learn how to crm & operations smarter.",
  ...
  return (
    <main style={{ background: "#0a0a0a", minHeight: "100vh", fontFamily: "inherit" }}>
      ...
      <section style={{ maxWidth: "800px", margin: "0 auto", padding: "80px 24px 60px", textAlign: "center" }}>
        <div style={{ display: "inline-block", background: "#ff006e22", border: "1px solid #ff006e44", borderRadius: "100px", padding: "6px 16px", fontSize: "12px", fontWeight: 600, color: "#ff006e", marginBottom: "24px", letterSpacing: "0.08em", textTransform: "uppercase" }}>Insights & Guides</div>
        ...
        <p style={{ fontSize: "18px", color: "#888", lineHeight: 1.6, margin: "0 0 40px" }}>
          Practical guides and how-to articles for small businesses. Topics covering crm & operations, team management, and building better workflows — coming soon.
        </p>
        ...
        <div style={{ background: "#111", border: "1px solid #1f1f1f", borderRadius: "16px", padding: "48px 40px", display: "inline-block", maxWidth: "500px", width: "100%" }}>
          ...
          <a
            ...
            style={{ display: "inline-block", background: "#ff006e", color: "#fff", padding: "12px 28px", borderRadius: "8px", fontWeight: 600, fontSize: "15px", textDecoration: "none" }}
          >
      ...
      <footer style={{ borderTop: "1px solid #1f1f1f", padding: "32px 24px", textAlign: "center", color: "#444", fontSize: "13px" }}>
        <p>© 2026 ZiggyHQ · <a href="/" style={{ color: "#666", textDecoration: "none" }}>Home</a> · <a href="/pricing" style={{ color: "#666", textDecoration: "none" }}>Pricing</a> · <a href="/privacy" style={{ color: "#666", textDecoration: "none" }}>Privacy</a> · <a href="/terms" style={{ color: "#666", textDecoration: "none" }}>Terms</a></p>
        <p style={{ marginTop: "8px" }}>Part of <a href="https://ziggybusiness.com" style={{ color: "#ff006e", textDecoration: "none" }}>ZiggyTech Business Suite</a></p>
      </footer>
    </main>
  );
}
